...
| 系統  a| 
從ONTAP 9.16.1 開始支援以下NetApp ASA r2 系統。這些系統提供統一的硬體和軟體解決方案，為僅使用 SAN 的客戶創造簡化的體驗。
...
| link:../learn-more/additional-supported-ontap-features.html#san-protocols["NVMe 空間取消分配預設為啟用"]  a| 
