...
ASA r2 儲存單元預設採用精簡配置。遷移虛擬機器工作負載時，虛擬磁碟（VMDK）也應該進行精簡配置。
...
* 詳細了解link:https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_setup_Broadcom_VMware_ESXi_iSCSI_MPIO_with_ONTAP_SAN_ASA["如何將 Broadcom VMware ESXi iSCSI MPIO 與ONTAP SAN ASA儲存系統集成"^]。
...
從 ONTAP 9.19.1 開始,FLI 支援 iSCSI 協定進行後端連線。

* 深入瞭解link:https://docs.netapp.com/us-en/ontap-fli/get-started/learn-about-data-migration.html["ONTAP FLI 遷移"^]。
