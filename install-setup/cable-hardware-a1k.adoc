...
summary: 將 ASA A1K 儲存系統連接到您的網路和儲存架，以啟用叢集通訊、管理存取和 SAN 主機連線。 
---
= 為 ASA A1K 儲存系統連接硬體電纜
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
將 ASA A1K 儲存系統連接到您的網路和儲存機櫃，以啟用叢集通訊、管理存取和 SAN 主機連線。此程序包括叢集 / HA 互連、管理網路、主機網路和儲存機櫃連接的佈線。
...
+
image::../media/drw_a1k_network_cabling1_ieops-1649.svg[連接至 100 GbE 乙太網路]
...
image::../media/oie_cable_sfp_gbe_copper.svg[10/25 GbE 乙太網路纜線]

image::../media/drw_a1k_network_cabling2_ieops-1650.svg[連接至 10/25 GbE 乙太網路]
...
ASA A1K 儲存系統支援配備 NSM100 或 NSM100B 模組的 NS224 機架。這些模組之間的主要差異為：
...
.. 將連接埠 e10b 連接至機櫃 1 NSM B 連接埠 e0b。
+
