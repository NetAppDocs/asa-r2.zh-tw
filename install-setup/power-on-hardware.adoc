...
.A1K
--
image::../media/drw_a1k_70-90_power_source_icon_ieops-1700.svg[A1K 儲存系統和 A70 或 A90 電源連線圖表]
...
====
+
** 系統會啟動開機程序。初始開機順序最多可能需要八分鐘。
** 在開機過程中，您將觀察 LED 閃爍，風扇啟動，表示控制器正在開機。
** 請注意，風扇第一次啟動時，可能會發出很大的噪音。啟動時風扇發出噪音是正常現象。
** 對於 ASA A20、A30、A50 和 ASA C30 儲存系統，系統機殼正面的層架 ID 顯示器不亮。
