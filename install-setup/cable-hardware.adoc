...
.關於這項工作
* 這些程序顯示一般組態。具體的佈線取決於您的儲存系統所訂購的元件。如需完整的組態詳細資料link:https://hwu.netapp.com["NetApp Hardware Universe"^]，請參閱。
...
.ASA A30 和 ASA A50 ：兩個雙埠 40/100 GbE I/O 模組
[%collapsible]
=====
...
=====
.ASA A20 ， A30 和 A50 ：一個 4 埠 10/25 GbE I/O 模組
[%collapsible]
=====
...
.ASA A20 ， A30 和 A50 ：一個 4 埠 64 Gb/s FC I/O 模組
[%collapsible]
=====
...
.A20、A30和A50
--
使用儲存系統隨附的儲存纜線，將每個控制器連接至 NS224 機櫃上對應的 NSM100B 模組，其中可能包括下列纜線類型：
