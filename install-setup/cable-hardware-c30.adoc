...
summary: 將 ASA C30 儲存系統連接到您的網路和儲存架，以啟用叢集通訊、管理存取和 SAN 主機連線。 
---
= 為 ASA C30 儲存系統連接硬體
:allow-uri-read: 
:icons: font
...
[role="lead"]
將 ASA C30 儲存系統連接到您的網路和儲存機櫃，以啟用叢集通訊、管理存取和 SAN 主機連線。此程序包括叢集 / HA 互連、管理網路、主機網路和儲存機櫃連接的佈線。
...
在每個控制器上，將連接埠 e2a、e2b、e2c 和 e2d 連接到乙太網路主機網路交換器。
...
在每個控制器上，將連接埠 2a、2b、2c 和 2d 連接到 FC 主機網路交換器。
